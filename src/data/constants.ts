...
using use = useUsing("use")`,
  ...
  [SkillNames.PYTHON]: {
    ...
    name: "python",
    label: "Python",
    shortDescription: "Clean, readable, and powerful for data and backend.",
    color: "#3776ab",
...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "Directorate of Economics and Statistics, Government of Nagaland",
    description: [
      "Automated data cleaning and preprocessing using Python (Pandas, NumPy).",
      "Built SQL dashboards and Excel automation, reducing manual reporting by 40%.",
      "Developed district-level visualization dashboards to support regional planning.",
    ],
    skills: [
      SkillNames.PYTHON,
      SkillNames.GIT,
  ...
  },
  {
    ...
    startDate: "Part-time",
    endDate: "Ongoing",
    title: "Volunteer — NGO (Education & Social Outreach)",
    company: "Education & Social Outreach",
    description: [
      "Supported education initiatives through data collection, reporting, and digital documentation.",
      "Collaborated with coordinators to improve information tracking and operational visibility.",
    ],
    skills: [
      SkillNames.GIT,
      SkillNames.GITHUB,
